...
{{--</html>--}}
    ...
    <head>
        ...
        <meta name="description" content="ashikchowdhury.xyz">
        <meta name="author" content="ASHIK CHOWDHURY">

        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

        <title>ASHIK CHOWDHURY</title>
                                ...
                                <div class="content hero">
                                    <div class="inner_content">
                                        ...
                                        <div class="name_holder">
                                            <h3>Ashik <span>Chowdhury</span></h3>
                                        </div>
                                    ...
                                    <div class="author_wrap">
                                        ...
                                        <div class="rightbox">
                                            ...
                                            <div class="buttons_wrap">
                                                <ul>
                                                    <li>
                                                        <a href="index-2.html"><span>Download CV</span></a>
                                                    </li>
                                                    <li class="anchor">
                                            ...
                                            <div class="inner_list">
                                                ...
                                                <div class="definitions_wrap">
                                                    ...
                                                    <div class="title_holder">
                                                        <h3><a href="index-2.html">How to Create Great Logo for Your Business</a></h3>
                                                    </div>
                                                    <div class="definition">
                                        ...
                                        <li class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.2s">
                                            <div class="inner_list">
                                                ...
                                                <div class="definitions_wrap">
                                                    ...
                                                    <div class="title_holder">
                                                        <h3><a href="index-2.html">How to Autumn Clean Your Design Career?</a></h3>
                                                    </div>
                                                    <div class="definition">
                                        ...
                                        <li class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.4s">
                                            <div class="inner_list">
                                                ...
                                                <div class="definitions_wrap">
                                                    ...
                                                    <div class="title_holder">
                                                        <h3><a href="index-2.html">Innovative Ways to Increase Brand</a></h3>
                                                    </div>
                                                    <div class="definition">
